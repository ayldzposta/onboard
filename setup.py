...
# Python 3.12+ removed distutils, require setuptools instead
try:
    from setuptools import Extension, Command
    from setuptools.command.build_ext import build_ext
except ImportError as exc:
    print('Onboard requires setuptools. Install python3-setuptools.', file=sys.stderr)
...
try:
    ...
    def parse_version(v):
        return distutils_version.StrictVersion(v)
...
current_ver = parse_version(DistUtilsExtra.auto.__version__)
required_ver = parse_version('2.12')
